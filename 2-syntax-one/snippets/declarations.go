...
var c []float64 = []float64{1, 2, 3.45, 4.56} // объявление переменной (массива) с присвоением значения
...
func main() {
	...
	g := struct { // создание переменной и присвоение ей литерала ьезымянного типа
		First string
		Last  string
	}{
		First: "James",
